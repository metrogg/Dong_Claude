...
from dong_claude.cli.commands.chat import cmd_chat
from dong_claude.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from dong_claude.cli.commands.ping import cmd_ping
from dong_claude.cli.commands.run import cmd_run
from dong_claude.cli.commands.trace import cmd_trace
from dong_claude.cli.commands.version import cmd_version
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="dong", description="DongClaude CLI")

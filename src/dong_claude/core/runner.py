...
from dong_claude.core.bus.events import RunFinishedEvent, RunStartedEvent
from dong_claude.core.compact.compactor import Compactor
from dong_claude.core.config import DongConfig
from dong_claude.core.context import ExecutionContext
from dong_claude.core.events.bus import EventBus, EventHandler
from dong_claude.core.events.writer import EventWriter
from dong_claude.core.llm.base import LLMProvider
from dong_claude.core.llm.provider import AnthropicProvider
from dong_claude.core.loop import AgentLoop
from dong_claude.core.mcp.server import McpServerManager
from dong_claude.core.memory.loader import load_context_file
from dong_claude.core.permissions.manager import PermissionManager
from dong_claude.core.runs import RUNS_DIR, new_run_id
from dong_claude.core.session.model import Session
from dong_claude.core.session.store import SessionStore
from dong_claude.core.subagent.registry import BackgroundTaskRegistry
from dong_claude.core.subagent.tool import AgentResultTool, SpawnAgentTool
from dong_claude.core.task.manager import TaskManager
from dong_claude.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from dong_claude.core.tools.registry import ToolRegistry
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.dong/context.md").expanduser())
        project_ctx = load_context_file(Path(".dong/context.md"))
